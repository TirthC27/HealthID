...
import { User, Sparkles, Heart, Stethoscope, Shield, Activity, ArrowLeft, ArrowRight, LogIn, Eye, EyeOff, Phone } from 'lucide-react';
...
export default function PatientLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user.role !== 'PATIENT') {
        showToast('error', 'Please use the doctor login for doctor accounts');
        return;
      }
      
      logAudit(user.id, 'LOGIN', 'Patient logged in');
      createSession(user);
      refreshSession();
  ...
  const handleDemoFill = () => {
    ...
    showToast('info', 'Demo credentials filled! Click sign in to test.');
  };
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-8">
        <div className="max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            Access your health records, appointments, and connect with healthcare providers securely.
          </p>
              ...
              <div className="mt-6 pt-4 border-t border-gray-100">
                <div className="text-center space-y-2">
                  <p className="text-sm text-gray-600">
                    ...
                    <Link href="/patient/register" className="text-orange-600 hover:text-orange-700 font-medium">
                      Register here
                    </Link>
                  </p>
                  <div className="flex justify-center space-x-4 text-xs text-gray-500">
                    <Link href="/doctor/login" className="hover:text-gray-700">
                      Doctor Portal
                    </Link>
                    <span>•</span>
